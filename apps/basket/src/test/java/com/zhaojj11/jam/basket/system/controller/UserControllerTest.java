...
import com.zhaojj11.jam.basket.system.service.impl.UserServiceImpl;
...
class UserControllerTest {
    ...
    void getByIdReturnNotNull() throws Exception {
        Mockito.when(userServiceImpl.findById(1L)).thenReturn(userData);
    ...
    void getByIdReturnNull() throws Exception {
        Mockito.when(userServiceImpl.findById(1L)).thenReturn(null);
        mockMvc.perform(MockMvcRequestBuilders
                        .get("/api/user/v1/{id}", 1L)
                )
